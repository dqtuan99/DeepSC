# -*- coding: utf-8 -*-
"""
Created on Sat Jan 20 02:34:09 2024
...
snr_range = np.arange(-10, 20, 2) # -10 to 20, step_size = 4
K_range = np.array([2, 4, 6, 8, 10])
test_snr_range = np.arange(0, 10, 5)
        ...
        for test_snr in test_snr_range:
            ...
            for batch_idx, data in enumerate(dataloader):
                ...
                for i in range(batch_size):
                    ...
                    sentence = corpus_data.get_sentence_as_word(index=i)
                    ...
                    inputs = torch.LongTensor(sentence_as_id).unsqueeze(0).to(device)
                    ...
                    output_as_id = s_predicted[0]
                    origin_sentence_as_id = inputs[0]
                ...
                print('BLEU 3 = {}'.format(avg_BLEU_4))
